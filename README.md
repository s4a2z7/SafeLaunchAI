...
| 지표 | v1.0 (Initial) | v2.0 (Base RAG) | **v3.1 (Advanced)** |
| :--- | :---: | :---: | :---: |
| **핵심 엔진** | 키워드 검색 (SQL) | TF-IDF / BM25 | **Semantic (Embedding)** |
| **평균 검색 속도** | 0.8초 (단순) | 1.8초 (RAG) | **0.45초** |
| **데이터 범위** | 약 500건 | 약 1,500건 | **2,200건+ (판례 포함)** |
| **분석 상세도** | 매칭 문구 열람 | 단일 LLM 요약 | **에이전트 협업 분석** |
| **Context Prec.** | 0.65 | 0.89 | **0.96** |
| **인터페이스** | 단순 리스트 | 대시보드 리포트 | **멀티턴 대화형 코치** |

## �📊 데이터베이스 현황 (Total: 18,300+)
